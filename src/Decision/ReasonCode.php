...
final class ReasonCode {
	...
	public const VELOCITY_THROTTLED         = 'VELOCITY_THROTTLED';
	...
	public const PAYMENT_FAILURE_CHALLENGE  = 'PAYMENT_FAILURE_CHALLENGE';
	public const AUTOMATION_EVIDENCE        = 'AUTOMATION_EVIDENCE';
	...
	public static function all(): array {
		return array(
			...
			self::VELOCITY_THROTTLED,
			self::PAYMENT_FAILURE_CHALLENGE,
			self::AUTOMATION_EVIDENCE,
		);
	}
}
