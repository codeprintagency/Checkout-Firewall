<?php
/**
 * Schema v3 definitions and verification contract.
 *
...
// phpcs:disable PluginCheck.Security.DirectDB.UnescapedDBParameter -- Schema inspection targets only the closed, prefix-validated TableNames registry; no request-derived identifiers are accepted.
...
KEY expires_at_gmt (expires_at_gmt)
	...
	public function expected_columns(): array {
		return array(
			'events'          => array( 'id', 'event_key', 'recipe_version', 'key_version', 'key_fingerprint', 'reason_code', 'action', 'identifier_type', 'identifier_hash', 'display_hint', 'gateway_id', 'bucket_start_gmt', 'bucket_seconds', 'event_count', 'first_seen_gmt', 'last_seen_gmt', 'metadata' ),
	...
	public function expected_indexes(): array {
		return array(
			'events'          => array( 'PRIMARY', 'event_key', 'bucket_start_gmt', 'last_seen_gmt', 'reason_last_seen', 'identifier_last_seen' ),
