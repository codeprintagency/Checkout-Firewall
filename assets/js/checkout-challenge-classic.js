( function ( window, document, $ ) {
	...
	const client = core.createClient( {
		...
		preflight: !! config.preflight, surface: config.surface || 'classic', autoSubmit: ! config.preflight,
	...
	if ( config.preflight ) { $( function () { client.begin(); } ); }
